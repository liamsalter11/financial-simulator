...
The pure-logic modules (`engine.js`, `montecarlo.js`, `loan.js`, `tax.js`, `payroll.js`, `recurrence.js`, `format.js`, `seeds.js`, `store.js`, `sample.js`) have no React dependency and are `import`ed directly in tests — no browser or stubbing needed.
