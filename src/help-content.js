...
export const HELP = {
  overview: {
    ...
    points: [
      ...
      ["Sharing a plan", "The Share button copies a link with the whole plan packed into it — no account, no upload, nothing stored anywhere. Opening someone's link never replaces what you have: it offers the plan, your own stays on screen until you say otherwise, and loading it is undoable like any other edit. The plain URL keeps working exactly as it always has, loading whatever you last saved here."],
  ...
  cashflow: {
    ...
    points: [
      ...
      ["Names and categories", "The name is yours to write — \"Rent\", \"Gym\", whatever you call it. The category is a fixed list, which is what lets spending be totted up across rows you named differently: rent and a mortgage are both housing. Anything you'd typed before became the name, and its category was matched from that same text."],
      ["Import from a statement", "Export a few months of transactions from your bank as CSV and paste them in. The file is read here in your browser and goes nowhere. Charges are grouped by merchant and a frequency is guessed from the spacing of the dates — a rent charge on the 1st of five months is unmistakable, a dozen coffees at random intervals is not, and the confidence badge says which you're looking at. Nothing is created from a guess: every row is shown with its amount, frequency and category editable, and only the ones you tick become expenses."],
